...
route.post("/", async (req, res) => {
    ...
    user = new Users(_.pick(req.body, ["firstName", "lastName", "address", "phoneNo", "email", "password", "userImage"]));
    ...
    res.send(_.pick(user, ["_id", "firstName", "lastName", "address", "phoneNo", "email", "userImage"]));
